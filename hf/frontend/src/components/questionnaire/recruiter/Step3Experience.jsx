...
import { addExperience, getExperiences, deleteExperience, addSkill, getSkills, deleteSkill } from '../../../services/recruiterService';
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      ...
      <div className="text-center mb-6">
        <FaBriefcase className="w-16 h-16 text-secondary mx-auto mb-4" />
      ...
      <div className="flex justify-between items-center pt-6 mt-6 border-t">
        ...
        <button
          type="button"
          onClick={handleNext}
          className="px-6 py-2 bg-secondary text-white rounded-lg hover:bg-secondary-dark"
        >
          Next
        </button>
      </div>
